...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'branch', 'as' => 'branch.', 'middleware' => ['module:branch','subscription:branch']], function () {
            Route::get('list', 'BranchController@list')->name('list');
            Route::post('store', 'BranchController@store')->name('store');
            // Route::get('edit/{banner}', 'BranchController@edit')->name('edit');
            Route::post('update/{banner}', 'BranchController@update')->name('update');
            
            Route::delete('delete/{banner}', 'BranchController@delete')->name('delete');
            
        });

        Route::group(['prefix' => 'pos-device', 'as' => 'pos-device.', 'middleware' => ['module:pos-device','subscription:pos-device']], function () {
            Route::get('list', 'PosDeviceController@list')->name('list');
            Route::post('store', 'PosDeviceController@store')->name('store');

            Route::post('update/{pos}', 'PosDeviceController@update')->name('update');
