...
class PosDeviceControllerApi extends Controller
{
    /**
    ...
    public function connectDevice(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            'code' => 'required|string|size:6|exists:pos_devices,code',
        ...
        try {
            ...
            if ($posDevice->connected_status === 1) {

                return $this->sendError('Device already connected.', 'Please conatct admin');
            }
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'connected_status' => $posDevice->connected_status ? 'Connected' : 'Disconnected',
                    'jwt_token' => $jwtToken,
    ...
    /**
     * Generate JWT Token for the POS device.
     */
    ...
    {
        $request->validate([
            'device_id' => 'required|string|exists:pos_devices,device_id',
        ]);
