    ...
    <script>
        ...
        const translations = {
            ...
            ar: {
                ...
                currencySymbol: "ريال سعودي", // New key for currency symbol
                totalLabel: "الإجمالي:",
            ...
            productsData.forEach(product => {
                ...
                listItem.innerHTML = `
                    ...
                    <div class="flex items-center space-x-2 quantity-controls ${lang === 'ar' ? 'rtl' : ''}">
                        ...
                        <input type="number" id="qty-${productIdSlug}" data-product-id="${productIdSlug}" data-price="${product.price}" value="0.0" min="0" step="1" class="w-20 p-2 border border-gray-300 rounded-md text-center focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all duration-200">
