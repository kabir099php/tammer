...
<body>
            ...
            <div class="container" >
                <div class="navbar-bottom-wrapper">
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            <a href="{{route('about-us')}}" class="{{ Request::is('about-us') ? 'active' : '' }}"><span>{{ translate('messages.Why') }}</span></a>
                        </li>
                        <li>
                            <a href="#demo" class=""><span>{{ translate('messages.Demo') }}</span></a>
                        </li>
                        <!-- <li>
    ...
    <footer>
        ...
        <div class="footer-bottom" style="border-radius:0px 0px 0 0 ; padding-top:10px; padding-bottom :15px;">
            <div class="copyright text-center mt-3" style="font-size:15px">

                All rights reserved to Wasl Technology Company &copy; 2025
                ...
                <div class="footer-wrapper ps-xl-5">
                    <div class="footer-widget">
                        <!-- <div class="footer-logo">
                            <a class="logo">
                                <img  class="onerror-image"  data-onerror-image="{{ asset('public/assets/admin/img/160x160/img2.jpg') }}" src="{{ asset('public/assets/landing/image/all-white.png') }}" alt="image">
                            </a>
                        </div> -->
                        <div class="txt">
