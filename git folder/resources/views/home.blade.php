...
@section('content')
    ...
    <section class="banner-section position-relative">
        ...
        <div class=" d-flex justify-content-center text-base banner-svg-img">
            <img src="{{asset('public/assets/landing/img/new_image/waslqr.jpg')}}" class="svg" alt="" style="width:100%">
        </div>
        <div class="px-xl-5 d-flex justify-content-center text-base banner-svg-img" id="demo">
            <img src="{{asset('public/assets/landing/img/new_image/1.jpg')}}" class="svg" alt="" style="width:100%">
        </div>
        <div class="px-xl-5 d-flex justify-content-center text-base banner-svg-img">
            <img src="{{asset('public/assets/landing/img/new_image/2.jpg')}}" class="svg" alt="" style="width:100%">
        </div>
    </section>
