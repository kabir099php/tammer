                                ...
                                id="default-form">
                                    <div class="form-group">
                                        <label class="input-label"
                                            ...
                                            ({{ translate('messages.Default') }} English) 
                                        </label>
                                        <input type="text" name="name[]" id="default_name"
                                            class="form-control" placeholder="{{ translate('messages.new_item') }}" 
                                             >
                                              <span id="arabic-name-message" style="display: none; color: red; margin-top: 5px;">
        Please add the Arabic name in the designated field at the top right.
    </span>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1">{{translate('messages.Branch')}}<span
                                                class="input-label-secondary">*</span></label>
                                        <select name="branch_id" id="branch_id" class="form-control js-select2-custom get-request"
                                                >
                                            <option value="">---{{translate('messages.select')}}---</option>
                                ...
                                <div class="col-sm-6 col-lg-4" id="unit_input">
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize" for="unit">{{translate('messages.barcode')}}</label>
                                        <input type="text"  value="" 
                                                name="barcode" class="form-control"
                                                placeholder="{{ translate('messages.Ex:') }} 123456">
                                    </div>
                                </div>
                                @if ($module_data['unit'])
                                <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="total_stock">{{translate('messages.total_stock')}}<span
                                                class="input-label-secondary">*</span></label>
...
document.addEventListener('DOMContentLoaded', function() {
    const defaultNameInput = document.getElementById('default_name');
    const messageSpan = document.getElementById('arabic-name-message');

    // Regular expression to check for Arabic characters
    const arabicRegex = /[\u0600-\u06FF]/;

    defaultNameInput.addEventListener('input', function() {
        const inputValue = defaultNameInput.value;

        if (arabicRegex.test(inputValue)) {
            // If Arabic characters are found, take these actions:
            ...
            // Optional: You can also give the user a temporary visual cue,
            // like a red border, to reinforce the invalid input.
            defaultNameInput.classList.add('is-invalid');
            
        } else {
            // If no Arabic characters, hide the message and remove any invalid class
            messageSpan.style.display = 'none';
            defaultNameInput.classList.remove('is-invalid');
        }
    });
});
