...
<body class="p-4 sm:p-6 md:p-8 bg-gradient-to-br from-indigo-50 to-purple-50 min-h-screen flex flex-col items-center justify-center @if($currentLang === 'ar') rtl @endif">
    ...
    <div class="max-w-xl w-full bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col transform transition-all duration-300 hover:scale-[1.005] mx-auto text-center">
        ...
        <div class="p-6 sm:p-8 bg-gradient-to-r from-purple-600 to-indigo-700 text-white rounded-t-xl fade-in">
            ...
            <p class="text-indigo-200 text-lg" data-key="orderSuccessMessage">
        ...
        <a href="#" id="downloadInvoiceButton" class="w-full sm:w-auto px-8 py-4 bg-purple-600 text-white font-bold rounded-lg shadow-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-opacity-75 transition duration-300 ease-in-out transform hover:scale-105 fade-in delay-300" data-key="viewReceiptButton">
                @if($currentLang === 'ar') عرض الإيصال @else View Receipt @endif
            </a>
            <a href="/checkout" class="mt-4 text-purple-600 hover:underline fade-in delay-400" data-key="continueShoppingLink">
