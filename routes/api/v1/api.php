...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::post('order/place', 'OrderController@place_order');
    Route::post('pos/login', 'OrderController@pos_login');
    Route::post('add-to-cart-guest', 'OrderController@addToCartGuest');
    Route::post('order/status-change', 'OrderController@statusChange');
    Route::get('order/status-check', 'OrderController@statusCheck');
    ...
    Route::post('pos-device/connect', 'PosControllerDevice@connectDevice');
    Route::post('pos-device/generate-token', 'PosControllerDevice@generateToken');
    Route::post('pos-device/disconnect', 'PosControllerDevice@disconnectDevice');
    ...
    Route::group(['middleware'=>['module-check']], function(){
        ...
        Route::group(['prefix' => 'items'], function () {
            ...
            Route::post('reviews/submit', 'ItemController@submit_product_review');
